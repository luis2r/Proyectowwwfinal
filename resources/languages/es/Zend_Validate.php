...
return array(
    ...
    "'%value%' is an empty string" => "'%value%' No contiene nada. Debe ingresar algun valor",

    // Zend_Validate_Alpha
    "Invalid type given, value should be a string" => "El tipo especificado es incorrecto, el valor debería ser una cadena de texto",
    "'%value%' contains non alphabetic characters" => "'%value%' contiene caracteres que no son alfabéticos",
    ...
    "Value is required and can't be empty" => "Debe ingresar un valor para este campo",
