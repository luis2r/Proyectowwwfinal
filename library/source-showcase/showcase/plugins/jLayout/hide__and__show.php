...
<?php echo YsUIDialog::initWidget('dialogId','style="display:none" title="Basic dialog"') ?>
  <?php echo YsJLayout::initBorderlLayout(array(YsJLayout::HGAP => 3,
    ...
    <?php echo YsJLayout::initCenter('centerPanel', 'style="width:33%; height:50%"') ?>
      <input type="button" value="Hide - North" id="btnHideNorth">
      <input type="button" value="Show - North" id="btnShowNorth">
...
echo
YsJQuery::click()->in('#btnHideNorth')
  ->handler(YsJLayout::hide(".border", "#northPanel",YsUIConstant::BOUNCE_EFFECT))->execute();
echo
YsJQuery::click()->in('#btnShowNorth')
  ->handler(YsJLayout::show(".border", "#northPanel",YsUIConstant::BLIND_EFFECT))->execute();
?>
