<?php YsJQuery::usePlugin(YsJQueryConstant::PLUGIN_JQPLOT); ?>
<?php $plugin = new YsJQPlot() ?>
...
<p>
jqPlot is a plotting and charting plugin for the jQuery Javascript framework.<br/><br/>
