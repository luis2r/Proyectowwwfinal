...
<?php echo YsUIDialog::initWidget('dialogId','style="display:none" title="Basic dialog" align="center"') ?>
  ...
  <input type="button" onclick="<?php echo YsJQCycle::pause()->in('#slideshow') ?>" value="Pause" />
  <input type="button" onclick="<?php echo YsJQCycle::resume()->in('#slideshow') ?>" value="Resume" />
