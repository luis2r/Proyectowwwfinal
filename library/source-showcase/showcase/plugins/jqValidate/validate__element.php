...
<form class="cmxform" id="commentForm" method="post" action="examples/response/commentResponse.php">
  ...
  <fieldset>
    ...
    <p align="center">
      ...
      <input class="button" type="button" id="btnReset" value="Reset"/>
      <input class="button" type="button" value="Validate Name" id="btnValidate" >
    </p>
  </fieldset>
...
YsJQuery::click()
  ->in('#btnReset')
  ->handler(
    YsJQValidate::resetForm("#commentForm")
  )
  ->execute()
?>
...
YsJQuery::click()
  ->in('#btnValidate')
  ->handler(
    YsJQValidate::validateElement("#commentForm",  "#cname")
  )
  ->execute()
?>