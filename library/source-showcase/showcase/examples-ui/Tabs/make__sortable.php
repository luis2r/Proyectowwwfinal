...
<?php echo YsUIDialog::initWidget('dialogId','style="display:none" title="Basic dialog"') ?>
  ...
  <br/>
  <?php echo YsUIButton::buttonTag('btnMakeSortable', 'Make sortable')?>
...
echo YsUITabs::build('#tabsId')->execute();

echo YsUIButton::build('#btnMakeSortable')->execute();
