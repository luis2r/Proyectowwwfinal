...
<?php echo YsUIDialog::initWidget('dialogId','style="display:none" title="Basic dialog"') ?>
  ...
  <?php echo YsUIButton::initToolbar('toolbarId') ?>
    <button onclick="<?php echo $tree->moveNode($node1,$node0) ?>">Move "Node 1" to "Node 0"</button>
    <button onclick="<?php echo $tree->moveNode($node0,$node1) ?>">Remove "Node 0" to "Node 1"</button>
