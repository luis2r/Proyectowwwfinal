...
?>
CRRM = creating, renaming, removing and moving nodes by the user.
<br/>
...
<?php echo YsUIDialog::initWidget('dialogId','style="display:none" title="Basic dialog"') ?>
  ...
  <?php echo YsUIButton::initToolbar('toolbarId') ?>
    <button onclick="<?php echo $tree->create() ?>">Create 1</button>
    <button onclick="<?php echo $tree->create($node1,'first','Enter a new name') ?>">Create 2</button>
    <button onclick="<?php echo $tree->create(-1,'first','Enter a new name') ?>">Create 3</button>
