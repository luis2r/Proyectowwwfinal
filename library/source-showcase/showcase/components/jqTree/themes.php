...
$tree->initWithAppleTheme();
$tree->initWithIcons(false);
$tree->initWithDots(false);
...
<?php echo YsUIDialog::initWidget('dialogId','style="display:none" title="Basic dialog"') ?>
  ...
  <?php echo YsUIButton::initToolbar('toolbarId') ?>
      <button onclick="<?php echo $tree->toggleIcons() ?>">Toggle Icons</button>
      <button onclick="<?php echo $tree->toggleDots() ?>">Toggle Dots</button>
      <button onclick="<?php echo $tree->changeToDefaultTheme() ?>">Default Theme</button>
      <button onclick="<?php echo $tree->changeToClassicTheme() ?>">Classic Theme</button>
      <button onclick="<?php echo $tree->changeToAppleTheme() ?>">Apple Theme</button>
      <button onclick="alert(jQuery('#treeId').jstree('get_theme'))">Get Theme</button>
