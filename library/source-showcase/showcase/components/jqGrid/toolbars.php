...
$grid->appendInToolbar('<input type="button" id="btnInToolbar" value="Click Me" style="height:20px;font-size:-3"/>');
...
<?php
echo
YsJQuery::live(YsJQueryConstant::CLICK_EVENT)
  ->in('#btnInToolbar')
  ->handler("alert('Hi! I am added button at this toolbar')")
  ->execute()
?>
