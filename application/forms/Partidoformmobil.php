...
class Application_Form_Partidoformmobil extends Zend_Form 
{

    public function init()
    {
           /* Form Elements & Other Definitions Here ... */
        $this->setName('partidomobil');
      
        //campo hidden para guardar id del ejercicio
//        
//        $acdionPane = new ZendX_JQuery_View_Helper_AccordionPane();
//        $acdionPane->accordionPane("haccordion", "Content for accordion 1", array('title' => 'Accordion 1'));
//        $acdionPane->accordionPane("haccordion", "Content for accordion 2", array('title' => 'Accordion 2'));
//        $acdionPane->accordionPane("haccordion", "Content for accordion 3", array('title' => 'Accordion 3'));
//        $acdionPane->accordionPane("haccordion", "Content for accordion 1", array('title' => 'Accordion 4'));
//        
//        $acdionContainer = new ZendX_JQuery_View_Helper_AccordionContainer();
//        
//        
//        $acdionContainer->accordionContainer("haccordion",
//                                              array('selected' => '1'),
//                                              array('class' => 'start', 'width' => '100%'));
//        
//                                                     
//        $this->view->helpaccordion = $acdionContainer;
//        
//        
//          
